...
def code_to_mesh(experiment_directory, checkpoint, keep_normalized=False):
    ...
    instance_filenames = utils.deep_sdf.data.get_instance_filenames(data_source, train_split)
...
if __name__ == "__main__":
    ...
    arg_parser = argparse.ArgumentParser(
        description="Use a trained DeepSDF decoder to generate a mesh given a obj code."
    )
