...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        "-s",
        dest="source_dir",
        default='/home/hbliu/surface/data/DISN/ShapeNet/ShapeNetCore.v1',
    ...
    arg_parser.add_argument(
        "--split",
        dest="split_filename",
        default='examples/splits/sv1_airplane.json',
    ...
    for class_dir in class_directories:
        ...
        for instance_dir in instance_dirs:
            ...
            try:
                mesh_filename = utils.deep_sdf.data.find_mesh_in_directory(shape_dir)
            ...
            except utils.deep_sdf.data.NoMeshFileError:
                logging.warning("No mesh found for instance " + instance_dir)
            except utils.deep_sdf.data.MultipleMeshFileError:
