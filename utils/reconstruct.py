...
from utils import deep_sdf, deep_sdf as ws
...
def reconstruct(
    ...
    for e in range(num_iterations):
        ...
        decoder.eval()
        sdf_data = utils.deep_sdf.data.unpack_sdf_samples_from_ram(
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        required=True,
        help="The experiment directory which includes specifications and saved networks "
    ...
    arg_parser.add_argument(
        ...
        dest="iterations",
        default=800,
        help="The number of iterations of obj code optimization to perform.",
    )
    arg_parser.add_argument(
        "--skip",
        dest="skip",
    ...
    npz_filenames = utils.deep_sdf.data.get_instance_filenames(args.data_source, split)
    ...
    for ii, npz in enumerate(npz_filenames):
        ...
        data_sdf = utils.deep_sdf.data.read_sdf_samples_into_ram(full_filename)
        ...
        for k in range(repeat):
            ...
            logging.debug("obj: {}".format(latent.detach().cpu().numpy()))
            ...
            if not save_latvec_only:
                start = time.time()
                with torch.no_grad():
                    utils.deep_sdf.mesh.create_mesh(
